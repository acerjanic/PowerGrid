...
//  PowerGrid
//
//  Created by Alex Cerjanic on 11/4/2015.
//  Copyright (c) 2015 MRFIL. All rights reserved.
//

#ifndef __PowerGrid__DWIDft
#define __PowerGrid__DWIDft
...
int test_DWIDft(string dataPath, uword Nx, uword Ny, uword Nz, uword L, uword niter, uword nc) {
    ...
    DWICGMCDFT<T1> S_DWI(kx, ky, kz, Nx, Ny, Nz, nc, tvec, SMap, vectorise(FM), 0 - PMap);
