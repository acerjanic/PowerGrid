...
if( PKG_CONFIG_FOUND AND NOT FFTW_ROOT )
    pkg_check_modules( PKG_FFTW REQUIRED "fftw3" )
endif()
...
if( FFTW_ROOT )
    ...
    find_library(
        FFTW_DOUBLE_LIB
        NAMES "fftw3"
        PATHS ${PKG_FFTW_LIBRARY_DIRS} ${PKG_FFTW_LIBDIR} ${LIB_INSTALL_DIR}
        )
    ...
    find_path(FFTW_INCLUDE_DIRS
        NAMES "fftw3.h"
        PATHS ${PKG_FFTW_INCLUDE_DIRS} ${PKG_FFTW_LIBDIR} ${INCLUDE_INSTALL_DIR}
        )
